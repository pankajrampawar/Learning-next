...
export default function Navbar() {
    ...
    return <main className='flex justify-between mt-5 md:mt-0 xl:mt-14 ml-8 items-center '>
        ...
        <div 
            className={`relative right-0 top-0 w-2/3 h-full md:h-auto pt-28 md:pt-8 gap-8 flex-col flex md:flex-row md:gap-12 menu md:justify-center md:items-center p-8 md:w-1/2 ${isMenuOpen ? 'block' : 'hidden'} md:flex min-w-fit`}
            >
            <div
